...
//		emojis.add(new Emoji(getFullName("001.png"), Color.parseColor("#ffffff")));
		...
		emojis.add(new Emoji("", getFullUrl("1407907183208.gif"), Color.parseColor("#ffffff")));
		emojis.add(new Emoji("", getFullUrl("1407983737416.gif"), Color.parseColor("#ffffff")));
		emojis.add(new Emoji("", getFullUrl("1407983767294.png"), Color.parseColor("#ffffff")));
